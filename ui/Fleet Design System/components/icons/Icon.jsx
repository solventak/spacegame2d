...
export function Icon({ name, size = 14, strokeColor, strokeWidth = 2, style, title }) {
  const inner = PATHS[name];
  if (!inner) return null;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={strokeColor || 'currentColor'}
