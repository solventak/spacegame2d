...
model: inherit
mcpServers: ["linear", "notion"]
tools: ["Read", "Grep", "Glob", "LS", "Edit", "Create", "ApplyPatch", "Execute", "TodoWrite", "linear___get_issue", "linear___save_issue", "linear___list_issue_statuses", "linear___get_issue_status", "linear___save_comment", "linear___list_comments", "notion___notion-fetch"]
---
...
5. Read the plan from the Notion page fetched in step 1. Implement following the plan's `## Plan` steps. Use small atomic commits (Conventional Commits format: `feat:`, `fix:`, `refactor:`, `test:`, `chore:`, `docs:`). Run `cargo fmt` after every meaningful edit so formatting stays clean.
